...
import com.wangzhixuan.utils.ReflectUtil;
...
//    @Pointcut("execution (* com.wangzhixuan.mapper.*.*(..))")  
//    @Pointcut("@annotation(com.wangzhixuan.annotation.DataSourceRouting)")
    @Pointcut("execution(* com.wangzhixuan.service.*.*(..))")
...
//    }
    ...
    /**
     * 根据@DataSourceRouting的属性值设置不同的dataSourceKey,以供DynamicDataSource
     */
    ...
    private String resolveDataSourceFromMethod(Class targetClass,
        ...
        if (m != null) {
            DataSourceRouting choDs = m.getAnnotation(DataSourceRouting.class);
...
//        }
    ...
    /**
     * <li>创建时间： 2013-6-17 下午4:33:03</li> <li>创建人：amos.zhou</li> <li>方法描述 : 类级别的 @DataSourceRouting
     * 的解析</li>
     *
     * @param targetClass
     * @return
    ...
    private String resolveDataSourceFromClass(Class targetClass) {
        DataSourceRouting classAnnotation = (DataSourceRouting) targetClass
                .getAnnotation(DataSourceRouting.class);
        // 直接为整个类进行设置
     ...
     * @return
     */
    private String resolveDataSourcename(DataSourceRouting ds) {
        return ds == null ? null : ds.dbkey();
    }
